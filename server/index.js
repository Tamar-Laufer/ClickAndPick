...
// CLIENT_URL may be a comma-separated list. We also accept any localhost /
// 127.0.0.1 origin so the vite dev server (5173) AND the preview build (4173)
// both work without reconfiguration; set CLIENT_URL explicitly in production.
// ========================================
