...
/* ── AdminKpis ─────────────────────────────────────────────────────────────
   The four headline cards: community size, items, total orders, and the site
   manager's personal cut (5% of every transaction's gross, computed
   server-side as stats.managerEarnings). */
