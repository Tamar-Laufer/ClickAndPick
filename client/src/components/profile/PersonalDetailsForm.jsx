/* ── PersonalDetailsForm ───────────────────────────────────────────────────
   The "פרטים אישיים" card. Read-only until "עריכה" is pressed; "שמירה" persists.
   All state + the toggle/save come from useProfileForm via props; email is shown
   from the auth user and is never editable. */
