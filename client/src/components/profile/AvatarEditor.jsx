/* ── AvatarEditor ──────────────────────────────────────────────────────────
   The profile photo + its controls. Pure presentation: every piece of state and
   every action comes from useAvatarUpload (passed in as `avatar`). Picking a
   file stages a preview and swaps the change/remove links for a save/cancel
   confirm; "⏳" shows while an upload or removal is in flight. */
