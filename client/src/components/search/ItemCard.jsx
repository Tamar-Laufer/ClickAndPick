...
import { priceText, distanceLabel } from '../../utils/format';
import { PAGE_SIZE } from '../../hooks/useItemSearch';

/* ── ItemCard ──────────────────────────────────────────────────────────────
   One result tile in the catalog grid. `index` drives the staggered entrance
   (--card-i); the modulo keeps each appended "Load More" batch restarting its
   cascade at 0. Distance is only shown when a location filter is active. */
