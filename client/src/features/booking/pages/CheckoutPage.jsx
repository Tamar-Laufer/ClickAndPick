...
export default function CheckoutPage() {
  ...
  const ownerName = fullName(item.owner, 'המשאיל');
  ...
  async function pay() {
    ...
    try {
      ...
      navigate('/checkout/success', {
        replace: true,
        state: { booking, item, startDate, endDate },
      });
    } catch (e) {
        ...
        <div className="wrap">
          ...
          <div className="checkout-grid">
            ...
            <form className="pay-form" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="fieldset">
                <h3><span className="num">2</span>איסוף הפריט</h3>
                <p className="pickup-note">
                  איסוף והחזרה ישירות מ{ownerName}. הכתובת המדויקת תתואם ותישלח
                  אליכם במייל לאחר אישור ההשאלה.
                </p>
              </div>
