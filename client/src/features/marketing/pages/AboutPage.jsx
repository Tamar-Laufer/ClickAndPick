...
/* ── "עלינו" — the manifesto ("הרעיון") lives here now, reached only from the
   ...
   (`.manifesto`, `.cta`) under the shared `.tg` namespace. The contact box is
   the shared FeedbackForm (same one in the footer), wrapped in `.fc-light` so
   its footer white-on-dark palette flips to dark-on-light for this section. */
